            ...
            <div class="slide-wrapper" style="width:300%;">
                <div class="slide">
                    <div class="slide-caption text-center">
                       <h3 class="text-uppercase">Passion for <span> fresh taste </span></h3>
                    </div>
                </div>
                <div class="slide slide2">
                    <div class="slide-caption text-center">
                        <h3 class="text-uppercase">Quality dairy products<span> of most trusted brands  </span></h3>
                    </div>
                </div>
                <div class="slide slide3">
                    <div class="slide-caption text-center">
                        <h3 class="text-uppercase">Healthy <span> and tasty</span></h3>
                    </div>
                </div>
            </div>
	...
	<div class="testimonials py-lg-5">
		<div class="container py-5">
			<div class="text-center wthree-title pb-sm-5 pb-3">
				<h3 class="w3l-sub">What Our Customers Say</h3>
				<h4 class="sub-title py-3">Reviews</h4>
			</div>
						...
						<ul class="slides">
							<li>
								<div class="w3_testimonials_grid">
									<p>"Quality products at afforable rates".</p>
							...
							<li>
								<div class="w3_testimonials_grid">
									<p>"Quality products and good delivery service".</p>
									<ul class="testi-w3ls-rate mt-4">
										<li>
											<i class="fas fa-star"></i>
										</li>
				...
				<div class="row inner_w3l_agile_grids-1 ">
					<div class="col-lg-7 w3layouts_choose_left_grid1">
						<div class="choose_top">
							<h3 class="w3l_header text-white">Our Story</h3>
							<h4 class="mb-3 mt-3 text-white">Want to know more about us?</h4>
							<p class="text-white">We provide you a wide range dairy products of different brands.Also we assure quality products.Always we will deliver the produtcs that are of quality and not out of date.</p>
...
<!-- case studies -->
	<section class="case_w3ls  py-lg-5">
		<div class="container py-5">
			<div class="text-center wthree-title pb-sm-5 pb-3">
				<h3 class="w3l-sub">Things We provide</h3>
				<h4 class="sub-title py-3">All for your happiness and it is important.</h4>
			</div>
			<!-- case studies row -->
			<div class="row">
				...
				<div class="col-lg-4 col-md-6 my-md-0 mt-4">
					<div class="img1 img2 img-grid  d-flex align-items-end justify-content-center p-3">
						<div class="img_text_w3ls">
							<h4>fresh flavoured milk</h4>
							<span> </span>
							<p>flavours to tickle your taste buds.</p>
						</div>
					</div>
				</div>
				<div class="col-lg-4 col-md-6 my-lg-0 mt-4">
					<div class="img1 img3 img-grid  d-flex align-items-end justify-content-center p-3">
						<div class="img_text_w3ls">
							...
							<span> </span>
							<p>goodness of milk anytime anywhere.</p>
						</div>
					</div>
				</div>
				<div class="col-lg-4 col-md-6 mt-4">
					<div class="img1 img5 img-grid  d-flex align-items-end justify-content-center p-3">
						<div class="img_text_w3ls">
							<h4>healthy life</h4>
							<span> </span>
							<p>promoting healthy lifestyles without compromising taste.</p>
						</div>
					</div>
				</div>
				<div class="col-lg-4 col-md-6  mt-4">
					<div class="img1 img4 img-grid  d-flex align-items-end justify-content-center p-3">
						<div class="img_text_w3ls">
							<h4>our promise</h4>
							<span> </span>
							<p>we love naturals,wholesome food and live for providing you with only the best products,made from the finest ingredients.</p>
						</div>
					</div>
				</div>
				<div class="col-lg-4 col-md-6 mt-4">
					<div class="img1 img6 img-grid  d-flex align-items-end justify-content-center p-3">
						<div class="img_text_w3ls">
							<h4>quality terms</h4>
							<span> </span>
                            <p>never compromising on our commitment to quality.</p>
					</div>
				</div>
			</div>
			<!-- //case studies row -->
		...
		<div class="container">
			<div class="row py-5">
				...
				<div class="col-lg-3 col-sm-6 fv5-contact">
					...
					<div class="fv3-contact mt-3">
						...
						<p>Ishan street, Benguluru City,Karnataka State 674905.</p>
					</div>
					<div class="fv3-contact mt-3">
					...
					<div class="fv3-contact mt-3">
						...
						<a href="mailto:example@email.com" class="text-secondary">dairymart@gmail.com</a>
					</div>
				</div>
				<!-- //footer grid1 -->
				<!-- footer grid2 -->
			...
			<div class="cpy-right text-center  pt-3">
				...
				<div class="copyrightbottom">
					<p class="text-secondary">© 2019 DairyMart. All rights reserved | Design by
