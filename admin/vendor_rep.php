...
<body>
    <h1><center>VENDOR REPORTS</center></h1>
...
//echo $txtStartDate; 
  ...
  //$txtS= date_format($txtStartDate,"d/m/Y");
    ...
    //echo $txtStartDate;
    //echo $txtEndDate;
 $query="select * from tbl_purchase_master where jdate between'$txtStartDate'and'$txtEndDate'";
    $tbl=getDatas($query);
...
}else
{
    ...
    <center><h3>The Vendors reports between <?php echo $txtStartDate ?> and <?php echo $txtEndDate ?></h3>
