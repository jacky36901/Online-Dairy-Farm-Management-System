...
$tbl=getDatas($sql);
if($tbl==null){
    echo "<div style='position:relative;top:250px;left:420px'><font color='red'>No Orders</font></div>";
}
else{
?>
<h1 style="position:relative;left:620px;top:120px;">ORDER REPORT</h1>
<center>
