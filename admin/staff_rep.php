...
//echo $txtStartDate; 
  ...
  //$txtS= date_format($txtStartDate,"d/m/Y");
    ...
    //echo $txtStartDate;
    //echo $txtEndDate;
 $query="select * from tbl_staff where staff_doj between'$txtStartDate'and'$txtEndDate'";
    $tbl=getDatas($query);

if($tbl==null){
        echo "<div style='position:relative;left:620px;top:150px;color:red'>No Staff </div>";

}else
{
    ?> <center><h3>Date:<?php echo $date ?></h3></center>
    <center><h3>The Staff reports between <?php echo $txtStartDate ?> and <?php echo $txtEndDate ?></h3>
    ...
    function myFunction()
        {
            window.print();
    				...
    				<table border="1" style="position:relative;width:200px;height:200px;left:300px;top:50px;">
