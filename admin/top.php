...
<body>
                    ...
                    <ul class="navbar-nav ml-lg-auto text-center">
                        <li class="nav-item active  mr-3 mt-lg-0 mt-3">
                         ...
                         <li class="nav-item dropdown mr-3 mt-lg-0 mt-3">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="staff_add.php">Add staff</a>
                        ...
                        <li class="nav-item dropdown mr-3 mt-lg-0 mt-3">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="view_vendor.php">View vendor</a>
                            </div>
                        </li>
                        <li class="nav-item dropdown mr-3 mt-lg-0 mt-3">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true"
                         ...
                         <li class="nav-item dropdown mr-3 mt-lg-0 mt-3">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="brand.php">Add Brand</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="view_brand.php">View Brand</a>
                            </div>
                        </li>
						<li class="nav-item">
    ...
    $tbl=getDatas($sql);
                                ...
                                {
    ?>
                                <a class="dropdown-item" href="view_med.php?mode=<?php echo $row[0];?>"><?php echo $row[0];?></a>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="view_ret.php">Customer</a>
                        </li>
						 <li class="nav-item">
                          ...
                          <li class="nav-item dropdown mr-3 mt-lg-0 mt-3">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="staff_rep_search.php">Staff Report</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="vendor_rep_search.php">Vendor Report</a>
                            
                              <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="order_rep_search.php">Order Report</a>
                        ...
                        <li class="nav-item dropdown mr-3 mt-lg-0 mt-3">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="../common/login.php">Logout</a>
                            </div>
                        </li>
