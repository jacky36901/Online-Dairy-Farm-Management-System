...
<font style="font-size:30;color:black;">

<form method="post" action="">
<table cellspacing="10" cellpadding="5" style="position:relative;top:160px;left:150px;">
<tr>
<td><font style="font-size:20;color:white;">Old Password</td>
...
if($tbl!=null)
{
	if($newpwd==$cpwd)
	{
$sql2="update tbl_login set password='$newpwd' where username='$username' and usertype='retailer'";
