	...
	<div class="testimonials py-lg-5">
		<div class="container py-5">
			<div class="text-center wthree-title pb-sm-5 pb-3">
				<h3 class="w3l-sub">What Our Customers Says</h3>
		...
		<div class="container">
			<div class="row py-5">
				...
				<div class="col-lg-3 col-sm-6 fv5-contact">
					...
					<div class="fv3-contact mt-3">
						...
						<a href="mailto:example@email.com" class="text-secondary">dairymart@redif.com</a>
					</div>
				</div>
				<!-- //footer grid1 -->
				<!-- footer grid2 -->
			...
			<div class="cpy-right text-center  pt-3">
				...
				<div class="copyrightbottom">
					<p class="text-secondary">© 2020 DairyMart. All rights reserved | Design by
